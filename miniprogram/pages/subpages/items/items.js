Page({
    ...
    data: [
      {
        ...
        tickets: "门票免费，但需要预约",
        introduction:
          `孙津川（1895－1928），男，又名方淦，曾用名孙竞川、孙继生，安徽寿县人，1895年1月22日，出生在南京中华门外宝塔根。1925年，孙津川决心参加革命。五卅运动期间，他因积极参加铁路工会工作而被选为工会筹备委员会委员。8月，加入了中国共产党，任淞沪特支书记。1927年3月，他直接领导的吴淞机厂的罢工斗争，在上海第三次武装起义总同盟的罢工中起了先锋作用。3月28日，两路工人代表80余人在闸北总工会会所开会，成立沪宁杭铁路总工会，孙津川当选为委员长。四一二反革命政变的当天下午，他带领工人参加了声讨蒋介石罪行的大会，并不顾个人安危，营救被捕同志，秘密恢复各地铁路工会。 

          1928年7月初的一个夜晚，市委决定在地下党员姚佐唐家召开秘密会议，由于叛徒告密，孙津川被捕。在狱中，面对敌人的审讯和严刑拷打，孙津川始终坚贞不屈。党组织和他的战友计划营救他，孙津川得知后，连忙带口信，坚决反对这种蛮干做法，表示决不能为了他而给革命带来更大的损失。10月6日清晨，孙津川英勇就义，牺牲时年仅33岁。现葬于雨花台知名烈士墓群中。
          `,
        opening_hours:
  ...
  onLoad(options) {
    var { items } = options;
    var card_item = this.data.data.filter((item) => item.name === items)[0];
    this.setData({
      ...this.data,
      data: card_item,
    });
